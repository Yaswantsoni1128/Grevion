...
const About_section_Card = ({btnText , details , img_url , title}) => {
  return (
    <>
      <div className={`bg-cover p-4 rounded-lg shadow-lg text-center flex flex-col gap-16`}
      style={{ backgroundImage: `url(${img_url})`  }}
      >
            <button className="bg-green-300 px-2 py-1 rounded-full text-xs font-semibold w-fit">{btnText}</button>

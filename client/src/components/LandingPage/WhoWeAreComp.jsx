...
function WhoWeAreComp() {
    return (
        <div className="flex flex-col md:flex-row items-center bg-white px-20 py-12 rounded-lg shadow-lg">
          {/* Image Section */}
          ...
          <div className="md:w-3/5 w-full py-6 px-20">
            ...
            <button className=" bg-green-950 text-white px-4 py-2 rounded-full font-normal shadow-md hover:font-semibold hover:bg-green-900 text-[1.2rem] mr-1">
                Know More
            </button>

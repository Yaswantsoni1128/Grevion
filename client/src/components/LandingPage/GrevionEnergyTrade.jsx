  ...
  return (
    <div className="bg-green-950 text-white pt-10 px-20 relative flex flex-col items-start mx-auto shadow-lg">
      <div className="w-[100%] md:w-[70%]">
        ...
        <p className="text-gray-100 mt-4 text-[1.2rem]">
      ...
      <div className="absolute top-24 right-44 bg-green-800 text-white p-3 rounded-full flex items-center justify-center w-32 h-32 shadow-md transform rotate-12 border-gray-300 border-8">

...
import { getAllSpoc } from "./PowerPlant.controllers.js";
import { addFarmer, updateFarmer, getAllFarmers ,deleteFarmer} from "./Spoc.controllers.js";

export { sendOtp,login,signUp, completeProfile , getUserProfile, addFarmer, updateFarmer, getAllFarmers, deleteFarmer, getAllSpoc}
